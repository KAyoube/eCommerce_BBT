                                    ...
                                    <form action="{{ url('updateProfil/' . Auth::user()->id) }}" method="post">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="firstname"
                                                placeholder="{{ Auth::user()->firstname }}" class="form-control">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="">new Lastname</label>
                                            <input type="text" name="lastname" placeholder="{{ Auth::user()->lastname }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="">new Adress</label>
                                            <input type="tel" name="adress" placeholder="{{ Auth::user()->adress }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="">new Phone</label>
                                            <input type="text" name="phone_number"
                                                placeholder="{{ Auth::user()->phone_number }}" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
