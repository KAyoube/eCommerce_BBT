        ...
        <div class="row">
            @foreach ($bubbleTea as $bubbleTeadata)
                <div class="col-md-2" id="cremeBrulee">
                    <img src="{{ $bubbleTeadata->img }}" class="img-thumbnail" alt="{{ $bubbleTeadata->name }}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                ...
                                                                <ul>
                                                                    @foreach ($poppings as $poppingsdata)
                                                                        ...
                                                                        ?>
                                                                        <li>
                                                                            <input type="radio" {{-- {{ $i == 0 ? 'checked="checked"' : '' }} --}}
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <ul>
                                                                    <li><input {{-- {{ $bubbleTeadata->sugar_quantity == 0 ? 'checked="checked"' : '' }} --}} type="radio"
                                                                            id="contactChoice1"
                                                                            name="contact{{ $bubbleTeadata->id }}"
                                                                            value="0">
                                                                        <label for="contactChoice1">0%</label>
                                                                    </li>
                                                                    <li><input {{-- {{ $bubbleTeadata->sugar_quantity == 1 ? 'checked="checked"' : '' }} --}} type="radio"
                                                                            id="contactChoice1"
                                                                            name="contact{{ $bubbleTeadata->id }}"
                                                                            value="1">
                                                                        <label for="contactChoice1">30%</label>
                                                                    </li>
                                                                    <li><input {{-- {{ $bubbleTeadata->sugar_quantity == 2 ? 'checked="checked"' : '' }} --}} type="radio"
                                                                            id="contactChoice1"
                                                                            name="contact{{ $bubbleTeadata->id }}"
                                                                            value="2">
                                                                        <label for="contactChoice1">50%</label>
                                                                    </li>
                                                                    <li><input {{-- {{ $bubbleTeadata->sugar_quantity == 3 ? 'checked="checked"' : '' }} --}} type="radio"
                                                                            id="contactChoice1"
                                                                            name="contact{{ $bubbleTeadata->id }}"
                                                                            value="3">
                                                                        <label for="contactChoice1">100%</label>
                                                                    </li>
                                                                    <li><input {{-- {{ $bubbleTeadata->sugar_quantity == 4 ? 'checked="checked"' : '' }} --}} type="radio"
                                                                            id="contactChoice1"
                                                                            name="contact{{ $bubbleTeadata->id }}"
                                                                            value="4">
